...
cat ~/insane/mutation.graphql | /usr/local/bin/gql-cli https://utjcezgxkfexda5vjmlq2g3nq4.appsync-api.us-west-2.amazonaws.com/graphql -H "x-api-key: $API_KEY" --transport appsync_http -V JSON:"$JSON"
